...
* 🧠 **AI Grammar Cleanup**: Automatically pipes the raw transcription through a local Ollama instance (`qwen2.5:3b`) to fix grammar, punctuation, and speech-to-text hallucinations.
